...
The TCPR system is being built by Wireshape around the TCR concept and the pioneering work done by Mike Goldin in his Token-Curated Registries 1.0 paper which can be read here.
